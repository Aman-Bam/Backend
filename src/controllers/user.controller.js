...
const refreshToken = asyncHandler(async (req, res) => {
    ...
    return res
        ...
        .cookie("accessToken", accessToken, options)
        .cookie("refreshToken", refreshToken, options)
        .json(new ApiResponce(200, {}, "Refresh token generated successfully"));
});

const verifyRefreshToken = asyncHandler(async (req, res) => {
    const { accessToken: incomingAccessToken } = req.cookies;
...
export { registerUser, loginUser, logoutUser, refreshToken, verifyRefreshToken };
